...
# SOURCE LOCAL FUNCTIONS --------------------------------------------------
  ...
  source("Scripts/06_Linkage_PSNU.R")
...
# | label: testing
 ...
 prep_modality_age(df_msd, params$cntry, trendscoarse) %>% 
   viz_modality_age()
...
viz_linkage(prep_national_linkage(df_msd, params$cntry),
            prep_psnu_linkage(df_msd, params$cntry))
