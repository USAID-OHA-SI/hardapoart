...
```{r}
# | label: youth_bulge_plhiv

df_natsubnat %>% 
  prep_pop_pyramid(params$cntry, "PLHIV") %>% 
  viz_pop_pyramid()

```

### Is there a youth bulge of the overall population we need to plan for?

```{r}
# | label: youth_bulge_pop

df_natsubnat %>% 
  prep_pop_pyramid(params$cntry, "Pop") %>% 
  viz_pop_pyramid()
...
### 10. Are certain populations by age or sex being missed when trying to reach the 3rd 95?
